...
import {
	useUpdateLearningPathForm,
	useUpdateLearningPathMutation,
} from "../-hooks";

export function UpdateLearningPathDialog({
	learningPath,
}: {
	...
	const {
		...
		reset,
		control,
	} = useUpdateLearningPathForm(learningPath);
	const { mutateAsync } = useUpdateLearningPathMutation();
